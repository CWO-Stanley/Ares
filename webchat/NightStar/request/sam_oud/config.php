...
/* ## ======================================== ## */  
  ...
  $station  = "Gezelligeblondecandy";
  $email    = "email@mailbox.com";
  $logo     = "images/logo.gif";
  
  $stationid   = 0;           //The ID of your registered station on AudioRealm.com
  $sam["host"] = "31.201.19.29"; //The IP address of the machine SAM is running on (DO NOT use a local IP address like 127.0.0.1 or 192.x.x.x)
  ...
  $picture_na  = $picture_dir."na.png"; //Use this picture if the song has no picture

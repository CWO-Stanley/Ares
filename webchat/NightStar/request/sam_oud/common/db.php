<?
if (stristr($_SERVER['SCRIPT_NAME'], "db.php")) {  // this line blocks directly accessing the db.php file. this is not needed
    die ("Access Denied");
}
if($_GET["commonpath"]){  // this line blocks rewriting the commonpath variable via direct access by the url ...&commonpath=...
die("Access Denied");
}
?>

...
{
	reqwin = window.open("request.php?songID="+songID, "_AR_request", "location=no,status=no,menubar=no,scrolling=no,resizeable=no,height=410,width=668");
	reqwin.focus();
}
...
function requestAudioRealm(songID, samhost, samport)
{
	...
	reqwin = window.open(path+"req.html?songID="+songID+'&samport='+samport+'&samhost='+samhost, "_AR_request", "location=no,status=no,menubar=no,scrollbars=yes,resizeable=yes,height=380,width=550");
	reqwin.focus();
}

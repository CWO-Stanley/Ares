var params = {};
params.host                         = "irc.chatters4all.nl";
params.quitMessage				 = "Heeft #jukebox-radio verlaten";
params.showNickPrefixes			= false;
params.realname                     = "#jukebox-radio WebChat";

	<?php
	 require_once('includes/bootstrap.inc.php');
            ...
            if (filter_var($_POST['gastemail'], FILTER_VALIDATE_EMAIL)) {
                            DB::Query("INSERT INTO berichtenbalk (radio, gastnaam, gastemail, bericht, ipadres, time)
                                                   VALUES
                                                   ('" . DB::Escape($_GET['id']) . "',
	...
	if(isset($success) && $success) { ?>
        ...
        <form action="" name="i-ReQuest" method="post" onsubmit="return checkform(this);"> 
               ...
               <div class="md-form">
                    ...
                    <textarea type="text" onkeyup="countChars(this);" ng-model="form.messinger" name="bericht" id="bericht" class="md-textarea" autocomplete="off"></textarea>

<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Aanmaken Radio Station / Verzoekserver
        </h1>
     </section>
	...
	<?php
	 if(isset($error) && $error != '') {
                    ...
                    echo '<div class="alert alert-success">Het Radio Station is aangemaakt</div>';
                }
	?>
      <div class="row">
        <div class="col-md-12">
...
<script type="text/javascript">
                      ...
                      <div class="col-md-4">
                      <input id="userid" name="userid" type="text" placeholder="Gebruikersnaam" value="<?php if(isset($radio) && trim($radio->username) != '') { echo $radio->username; } ?>" class="form-control input-md" onkeypress="CheckSpace(event)">

...
<head>
  ...
  <title>Chattersworld Verzoekserver | Wachtwoord Vergeten</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="https://chattersworld.nl"><b>Chattersworld</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Wachtwoord Vergeten</p>
  ...
  <form action="forgotpw.php" method="post">
                <div class="body bg-gray">
                    ...
                    <div class="form-group">
                        <input type="text" name="userid" class="form-control" placeholder="Gebruikersnaam of E-mailadres"/>
                    </div>
                </div>
                <div class="footer">                                                               
                    <button type="submit" class="btn bg-olive btn-block">Wachtwoord reset aanvragen</button>  
                </div>
            </form>
  <!-- /.login-box-body -->
</div>

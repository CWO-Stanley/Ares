...
(function(c) {
	...
	c.fn.emojiInit = function(b) {
		...
		if (void 0 == b || 0 >= b.length) option.error(null, "target object is undefined");
			...
			b.after("<div id='faceBlock' style='background:rgb(216, 216, 216);border-radius: 12px;display: none;position: relative;border: 1px solid #e2e2e2;padding: 5px;right: -150px;top: 25px;width: 300px;'>" + a + "</div>");
